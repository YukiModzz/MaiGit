...
const ceemde = JSON.parse(fs.readFileSync('./arquivos/importantsJson/totalcmd.json'));
...
/*async function upload(fileBuffer, fileType) {
    ...
    try {
        const response = await fetch('http://nxf-01.nexfuture.com.br:25571/upload-single', {
            method: 'POST',
            body: form,
...
const banner2 = cfonts.render((`${tempo}\n\n\n\nCriador: YUKI-MODS\nNumero:+55 51 94709091\nMAI BOT DOMINA`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`MAI|SYSTEM`), {
  font: 'block',
  align: "center",
...
authorname = 'Yuki Modz'
packname = 'Yuki Modz'

const usedCommandRecently = new Set()

chyt = `555194709091@s.whatsapp.net`
